...
function NtlmClient(credentials, AxiosConfig) {
    ...
    var authenticationType = (_a = credentials.customAuthenticationType) !== null && _a !== void 0 ? _a : "NTLM";
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    ntlmheader = ((_a = error.headers['www-authenticate'].split(',').find(function (header) { return header.match(new RegExp(" *".concat(authenticationType))); })) === null || _a === void 0 ? void 0 : _a.trim()) || '';
                    ...
                    if (ntlmheader.length < 50) {
                        t1Msg = ntlm.createType1Message(credentials.workstation, credentials.domain, authenticationType);
                        error.config.headers["Authorization"] = t1Msg;
                    }
                    else {
                        t2Msg = ntlm.decodeType2Message((ntlmheader.match(new RegExp("^".concat(authenticationType, "\\s+(.+?)(,|\\s+|$)"))) || [])[1], authenticationType);
                        t3Msg = ntlm.createType3Message(t2Msg, credentials.username, credentials.password, credentials.workstation, credentials.domain, authenticationType);
